<template>
  <div class="app-container">
    ...
    <div v-else-if="couponInfo.rangeType == 'CATAGORY'" key="CATAGORY">
    ...
    <div v-else="couponInfo.rangeType == 'TRADEMARK'" key="TRADEMARK">
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      this.$API.couponInfo.saveCouponRule(ruleData).then(response => {
    ...
    queryTradeSearch(queryString, cb) {
      ...
      this.$API.trademark.findBaseTrademarkByKeyword(queryString).then(response => {
